...
public class GooglePlayAPI {
    ...
    public void login(
        ...
        /*HttpEntity responseEntity = executePost(URL_LOGIN, new String[][]{
                ...
                {"has_permission", "1"},
                {"source", "android"},
                {"androidId", this.getAndroidID()}, // missing
        ...
        Map<String, String> response = Utils.parseResponse(new
                String(Utils.readAll(responseEntity.getContent())));
        if (response.containsKey("Auth")) {
            setToken(response.get("Auth"));
        } else {
            throw new GooglePlayException(500, "Authentication failed!");
        }*/
        Identity ident = Identity.signIn(getClient(), getEmail(), password, sdkVersion);
