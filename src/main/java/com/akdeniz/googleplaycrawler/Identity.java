...
class Identity {
     ...
     * Sing into Play
     *
     * @param req parameter object with username, password and locale.
     * @return new instance
     ...
     * @throws IOException
     */
    public static Identity signIn(HttpClient client, String uid, String pwd, int sdkVersion)
            throws ClientProtocolException,
        ...
        params.add(new BasicNameValuePair("sdk_version", String.valueOf(sdkVersion)));
